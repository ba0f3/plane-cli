...
LDFLAGS=-ldflags "-X github.com/ba0f3/plane-cli/cmd.version=$(VERSION) -X github.com/ba0f3/plane-cli/cmd.commit=$(COMMIT) -X github.com/ba0f3/plane-cli/cmd.date=$(DATE)"
